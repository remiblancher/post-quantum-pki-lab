...
run_cmd "pki cert issue --ca-dir output/code-ca --profile profiles/pqc-code-signing.yaml --cn \"ACME Software\" --out output/code-signing.crt --key-out output/code-signing.key"
